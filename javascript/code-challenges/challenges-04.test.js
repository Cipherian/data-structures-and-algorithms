...
const sortPeople = (arr) => arr.sort((a,b) => a.lastName.charCodeAt(0) - b.lastName.charCodeAt(0));
...
const sortPeopleBetter = (arr) => {
  return arr.sort((a,b) => {
    ...
    result !== 0 ? result : a.firstName.localeCompare(b.firstName);
    result !== 0 ? result : a.age.localeCompare(b.age);
